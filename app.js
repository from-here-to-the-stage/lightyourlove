...
function applyLangToCards(){
  const isEn = lang==='en';
  // ページ内すべての txt-jp/txt-en を一括切替（compassFromLabel含む）
...
// ══ ll(): GCPキャリブレーション済み Mercator投影 ══════════
// 32点のGround Control Points（実測ピクセル座標）から
// 最小二乗回帰で導出。X誤差avg 0.03px / Y誤差avg 5.5px
// 参照画像: 1338×921px の世界地図
// ──────────────────────────────────────────────────────────
const GCP = {
  IMG_W:   1338,    // 参照画像幅 (px)
  IMG_H:   921,     // 参照画像高さ (px)
  LNG_S:   4.090163,  // px per degree longitude
  LNG_O:   719.5148,  // x offset at lng=0
  LAT_S:  -265.7058,  // px per Mercator unit
  LAT_O:   588.8772,  // y offset at equator
};
...
function selectStop(v,i){
  try {
    ...
    if(geoGranted&&userLat)updateCompassFromUser();
      ...
      if(lbl){
      lbl.innerHTML=`<span class="txt-jp">${TOUR[fi].city} → ${v.city} (📍タップで現在地から)</span><span class="txt-en" style="display:${lang==='en'?'':'none'}">${TOUR[fi].city} → ${v.city} (tap 📍 for your location)</span>`;
    }
    }
  } catch (e) {
...
const CONTINENTS=[
  ...
  [
    // スカンジナビア〜バルト海
    [71.1,28.2],[70.4,22.0],[69.1,17.9],[67.9,15.0],[66.0,13.4],
    [64.5,11.2],[63.0,7.8],[61.0,4.8],[59.2,5.3],[57.0,7.6],
    [55.5,8.0],[54.3,9.5],[55.0,12.6],[56.2,15.5],[56.0,18.0],
    [54.5,18.5],[54.0,19.5],[54.5,20.5],[55.0,22.0],[55.5,23.5],
    [56.0,24.0],[57.0,24.4],[58.5,24.7],[59.3,26.0],[59.5,28.0],
    // フィンランド湾〜バルト
    [60.0,27.5],[60.3,25.0],[59.5,24.5],[58.0,24.0],[57.5,21.0],
    [57.0,24.3],[56.5,21.0],[56.0,18.0],[55.5,14.0],[55.0,12.5],
    // デンマーク・北海
    [57.5,10.5],[58.0,8.0],[57.5,7.0],[56.0,8.5],[55.5,10.5],
    [56.5,11.5],[57.0,11.2],[56.5,8.5],[55.5,8.5],[55.0,9.5],
    [54.5,9.0],[54.0,8.0],[53.5,8.5],[53.0,8.0],[52.5,4.5],
    [52.0,4.0],[51.5,4.5],[51.0,3.0],[50.8,2.0],[50.5,0.5],
    [50.0,-0.5],[49.5,-2.0],[48.5,-3.0],[48.0,-4.5],[47.5,-3.0],
    [47.0,-2.5],[46.5,-1.5],[46.0,-1.5],[45.5,-1.0],[44.5,-1.5],
    [43.5,-2.0],[43.0,-4.0],[42.5,-6.0],[42.0,-8.5],[42.0,-9.0],
    [41.0,-8.5],[40.5,-7.5],[39.5,-7.0],[39.0,-9.0],[38.5,-9.5],
    [37.5,-9.0],[37.0,-8.5],[36.5,-6.5],[36.0,-5.5],[36.2,-3.5],
    [36.5,-2.0],[37.0,0.0],[38.0,0.5],[39.0,0.0],[40.0,0.5],
    [40.5,1.5],[41.0,2.0],[41.5,2.5],[42.0,3.5],[43.0,5.0],
    [43.5,7.5],[44.0,8.0],[44.5,9.0],[44.0,10.5],[43.5,12.5],
    [43.0,13.5],[42.5,14.0],[42.5,16.0],[42.0,18.0],[41.5,19.5],
    [41.0,19.5],[40.5,20.5],[40.0,19.5],[39.5,20.5],[38.5,20.5],
    [38.0,21.5],[37.5,22.0],[37.0,22.5],[36.5,22.5],[36.0,23.0],
    [36.5,27.5],[36.0,28.5],[36.5,29.5],[37.0,28.0],[37.5,29.0],
    [38.5,30.5],[40.0,36.0],[41.0,38.0],[41.5,40.5],[41.0,42.5],
    [40.5,43.0],[40.0,44.5],[39.0,45.0],[38.5,46.5],[37.5,47.5],
    [37.0,49.0],[36.5,50.0],[36.0,52.0],[36.5,54.0],[37.0,56.0],
    // カスピ海〜中央アジア
    [37.5,55.0],[37.0,57.5],[36.5,60.0],[37.0,62.0],[37.5,64.5],
    [38.0,66.0],[38.5,67.5],[38.0,70.0],[37.5,71.0],[37.0,72.5],
    [37.5,74.0],[38.0,76.5],[38.5,78.0],[37.5,79.5],[36.0,81.0],
    [35.5,82.5],[35.0,84.0],[34.5,86.0],[35.0,88.0],[35.5,90.0],
    // チベット〜雲南
    [36.0,92.0],[36.5,94.0],[37.0,96.0],[36.0,98.0],[35.0,100.0],
    [34.0,102.0],[33.0,104.0],[32.0,106.0],[31.0,108.0],[30.0,110.0],
    [29.0,111.0],[28.0,113.0],[27.0,114.0],[26.0,115.0],[25.0,116.0],
    [24.0,117.0],[23.5,117.5],[23.0,116.5],[22.5,115.0],[22.0,114.0],
    // 中国南岸・ベトナム
    [21.5,110.5],[21.0,110.0],[20.0,110.5],[19.0,109.5],[18.5,108.5],
    [18.0,107.5],[17.0,107.0],[16.5,107.5],[16.0,108.0],[15.0,108.5],
    [14.0,109.5],[13.0,109.5],[12.5,109.0],[12.0,109.5],[11.5,109.0],
    [11.0,108.5],[10.5,107.5],[10.0,104.5],[9.5,104.0],[9.0,104.5],
    // タイ・マレー半島
    [8.0,100.0],[7.5,100.5],[7.0,101.0],[6.5,101.5],[6.0,102.0],
    [5.5,103.0],[5.0,103.5],[4.5,103.5],[4.0,103.0],[3.5,103.5],
    [3.0,104.0],[2.5,104.0],[2.0,103.5],[1.5,103.5],[1.0,104.0],
    [1.3,103.8],[1.5,104.0],[2.0,103.5],
    // ミャンマー・バングラデシュ
    [2.5,102.0],[3.0,101.5],[4.0,100.5],[5.0,100.5],[6.0,100.0],
    [7.0,99.5],[8.0,98.0],[9.0,98.5],[10.0,98.0],[11.0,98.5],
    [12.0,99.0],[13.0,100.0],[14.0,100.0],[15.0,100.0],[16.0,98.5],
    [17.0,97.5],[18.0,96.5],[19.0,94.0],[20.0,93.0],[21.0,92.5],
    [22.0,91.5],[22.5,90.5],[21.5,89.0],[21.0,89.5],[20.5,90.5],
    [20.0,92.0],[21.0,92.0],[22.0,91.5],
    // インド東岸
    [22.5,88.5],[22.0,87.5],[21.5,87.0],[20.5,86.5],[19.5,85.5],
    [18.5,84.5],[17.5,83.5],[16.5,82.0],[15.5,80.5],[14.5,80.0],
    [13.5,80.5],[13.0,80.0],[12.5,80.5],[12.0,79.5],[11.5,79.5],
    [11.0,79.5],[10.5,80.0],[10.0,80.5],[9.5,78.5],[9.0,77.5],
    [8.5,77.5],[8.0,77.5],[8.3,76.8],[8.5,76.5],[9.0,76.5],
    [9.5,76.0],[10.0,76.5],[10.5,75.5],[11.0,75.0],[11.5,74.5],
    [12.0,74.5],[13.0,74.5],[14.0,74.5],[15.0,73.5],[16.0,73.0],
    [17.0,73.0],[18.0,72.5],[19.0,72.5],[20.0,72.5],[21.0,72.5],
    // インド西岸
    [22.0,68.5],[22.5,68.5],[23.0,68.5],[24.0,68.0],[25.0,68.5],
    [26.0,66.5],[25.5,63.5],[25.0,62.0],[24.5,61.5],[24.0,60.5],
    // アラビア半島
    [23.5,57.5],[22.5,59.5],[22.0,60.0],[21.5,60.0],[20.5,59.0],
    [19.5,58.0],[18.5,57.0],[17.5,55.0],[16.5,53.0],[15.5,52.0],
    [14.5,51.5],[13.5,50.5],[13.0,48.0],[12.5,45.5],[12.0,44.5],
    [11.5,43.5],[11.0,43.5],[11.5,44.5],[12.0,44.0],[12.5,44.5],
    [13.0,45.0],[14.0,48.0],[15.0,51.0],[16.0,53.0],[17.0,55.0],
    [18.0,56.5],[19.0,57.5],[20.0,58.5],[21.0,59.0],[22.0,59.5],
    [23.0,58.0],[23.5,57.0],[24.0,56.5],[24.5,56.0],[25.0,57.0],
    [25.5,56.5],[24.0,54.0],[24.5,53.0],[25.0,52.5],[25.5,51.5],
    [26.0,50.5],[26.5,50.0],[27.0,49.5],[27.5,49.0],[28.0,48.5],
    [28.5,48.5],[29.0,48.0],[29.5,47.5],[29.0,47.5],[28.5,47.5],
    [29.0,46.0],[29.5,45.5],[30.0,44.5],[30.5,43.5],[31.0,42.5],
    [31.5,41.5],[32.5,39.5],[33.0,38.0],[33.5,37.5],[34.0,36.5],
    [35.0,35.5],[36.0,36.0],[36.5,36.5],[37.0,37.0],[37.5,37.5],
    [38.0,38.5],[38.5,39.5],[39.0,41.0],[39.5,41.5],[40.0,40.5],
    [40.5,40.5],[41.0,40.5],[41.5,41.5],[42.0,41.5],[42.5,41.5],
    [43.0,42.0],[43.5,43.0],[44.0,43.5],[44.5,42.0],[44.0,41.0],
    [43.5,40.0],[43.0,40.5],[43.5,42.5],[43.0,43.0],[42.5,43.5],
    // 黒海〜ウクライナ
    [42.0,44.0],[42.5,44.5],[43.0,45.0],[44.0,46.5],[44.5,48.0],
    [45.0,49.0],[46.0,50.5],[47.0,51.5],[47.5,51.5],[47.0,50.0],
    [46.5,49.5],[46.0,48.5],[45.5,47.5],[45.0,46.5],[44.5,46.0],
    [44.0,45.5],[43.5,45.0],[43.0,44.5],[42.5,44.5],[42.0,44.5],
    [41.5,44.5],[41.0,44.0],[40.5,44.5],[40.0,45.0],[39.5,45.5],
    [39.0,46.0],[38.5,47.0],[38.0,48.0],[37.5,49.0],[37.0,50.0],
    [36.5,52.0],[36.0,53.0],[36.5,54.5],[37.0,56.0],[37.5,57.5],
    [38.0,58.5],[38.5,60.5],[37.5,62.0],[37.0,64.0],[38.0,65.0],
    // シベリア・中央アジア
    [44.0,60.0],[48.0,58.5],[50.0,57.0],[52.0,57.0],[54.0,57.0],
    [55.0,58.0],[56.0,59.0],[57.0,60.0],[58.0,62.0],[59.0,63.0],
    [60.0,63.5],[61.0,65.0],[62.0,67.0],[63.0,68.5],[64.0,70.0],
    [65.0,72.0],[66.0,74.0],[67.0,76.0],[68.0,79.0],[69.0,82.0],
    [70.0,84.0],[70.5,86.0],[71.0,88.0],[72.0,92.0],[73.0,96.0],
    [73.5,100.0],[74.0,104.0],[74.5,107.0],[73.5,110.0],[73.0,114.0],
    [73.5,118.0],[73.0,122.0],[72.5,126.0],[72.0,130.0],[71.0,132.0],
    [70.0,133.0],[69.0,136.0],[68.5,138.0],[68.0,140.0],[67.5,142.0],
    [67.0,143.0],[66.5,141.0],[66.0,143.0],[66.5,145.0],[67.0,146.0],
    [68.0,148.0],[69.0,150.0],[70.0,152.0],[71.0,154.0],[71.5,155.0],
    [72.0,158.0],[71.5,160.0],[70.5,161.0],[69.5,161.0],[68.5,161.0],
    [67.5,163.0],[66.5,163.0],[65.5,166.0],[64.5,163.0],[63.5,163.0],
    [62.5,163.0],[61.5,161.0],[60.5,161.0],[59.5,162.0],[58.5,161.0],
    [57.5,158.0],[56.5,162.0],[56.0,161.0],[56.5,160.0],[57.0,158.0],
    [57.5,156.0],[58.0,154.0],[57.5,152.0],[56.5,150.0],[56.0,152.0],
    [55.0,154.0],[54.5,152.0],[54.0,150.0],[53.5,148.0],[52.5,146.0],
    [52.0,144.0],[50.5,142.0],[49.0,142.0],[48.0,142.0],[47.0,142.0],
    [46.5,141.5],[46.0,142.0],[45.0,141.5],[44.0,142.0],[43.5,143.0],
    [43.0,144.0],[42.5,143.0],[42.0,141.0],[41.0,141.0],[40.0,141.0],
    [39.0,141.5],[38.0,141.5],[37.0,141.0],[36.0,140.5],[35.5,140.0],
    [35.0,139.0],[34.5,138.0],[34.0,136.5],[33.5,135.0],[33.0,131.5],
    [32.5,130.5],[32.0,130.0],[31.5,130.5],[31.0,130.5],[30.5,130.0],
    [30.5,131.0],[31.0,131.5],[32.0,131.0],[33.0,132.0],[33.5,134.0],
    [34.0,135.5],[34.5,137.0],[35.0,138.0],[35.5,140.0],[36.0,141.5],
    [37.0,141.5],[38.0,141.5],[39.0,142.0],[40.0,142.0],[41.0,142.5],
    [42.0,142.5],[42.5,141.5],[43.0,141.0],[43.5,141.5],[44.0,143.0],
    [44.5,145.0],[44.0,146.5],[43.5,148.0],[43.0,147.0],[42.5,141.0],
    [42.0,140.0],[41.5,140.5],[41.0,141.0],[40.5,140.5],[40.0,140.0],
    [39.5,140.0],[39.0,141.0],[38.5,141.5],[38.0,141.0],[37.5,140.5],
    [37.0,140.5],[36.5,136.5],[36.0,136.0],[35.5,136.5],[35.0,137.0],
    [34.5,136.5],[34.0,135.5],[33.5,135.0],[33.0,131.5],[32.5,131.0],
    [32.0,130.5],[31.5,130.5],[31.0,131.0],[30.5,131.0],[30.0,131.5],
    [29.5,130.0],[29.0,130.0],[28.5,130.5],[28.0,130.0],[27.5,128.0],
    [27.0,128.5],[26.5,128.0],[26.0,127.5],[25.5,124.0],[25.0,122.0],
    [24.5,122.0],[24.0,122.5],[23.5,121.5],[23.0,120.5],[22.5,120.5],
    [22.0,120.5],[21.5,120.0],[20.5,120.0],[20.0,120.0],[19.5,120.0],
    // フィリピン海・南シナ海沿岸
    [18.5,108.5],[18.0,107.5],[17.5,107.0],[17.0,107.5],[16.5,108.0],
    [16.0,108.5],[15.5,109.0],[15.0,108.5],[14.5,110.0],[14.0,110.0],
    [13.5,109.5],[13.0,109.5],[12.5,109.0],[12.0,109.5],[11.5,109.0],
    [11.0,108.5],[10.5,107.5],[10.0,106.5],[9.5,106.0],[9.0,105.0],
    [8.5,104.5],[8.0,104.5],[7.5,103.5],[7.0,103.5],[6.5,102.5],
    [6.0,102.0],[5.5,101.5],[5.0,101.0],[4.5,100.5],[4.0,100.5],
    [3.5,101.0],[3.0,101.5],[2.5,102.0],[2.0,103.5],[1.5,104.0],
    [1.3,103.8],
    // ここから大陸本体に戻る
    [2.0,103.5],[2.5,102.0],[3.5,101.0],[4.5,100.5],[5.5,100.5],
    [6.5,100.0],[7.5,99.5],[8.5,97.5],[9.5,98.5],[10.5,98.0],
    [11.5,98.5],[12.5,99.0],[13.5,100.0],[14.5,100.0],[15.5,100.0],
    [16.5,98.5],[17.5,97.5],[18.5,96.5],[19.5,94.0],[20.5,93.0],
    [21.5,92.5],[22.0,91.5],[22.5,91.0],[22.0,89.5],[21.5,89.5],
    [21.0,89.5],[20.5,90.5],[20.0,92.0],[20.5,92.5],[21.0,92.5],
    [22.0,91.5],[22.5,91.0],[23.0,91.5],[23.5,91.5],[24.0,92.0],
    [24.5,91.0],[24.0,89.0],[23.5,88.5],[23.0,88.0],[22.5,88.5],
    [22.0,87.5],[21.5,87.0],[21.0,86.5],[20.0,86.5],[19.0,85.5],
    // 中国〜モンゴル〜シベリア回帰
    [24.0,121.0],[24.5,121.0],[25.0,121.5],[26.0,120.0],[27.0,121.0],
    [28.0,121.5],[29.0,122.0],[30.0,122.5],[30.5,122.0],[30.0,121.5],
    [29.5,122.0],[30.0,122.0],[31.0,122.0],[31.5,121.5],[32.0,121.5],
    [32.5,121.5],[33.0,121.0],[33.5,120.0],[34.0,120.5],[34.5,119.5],
    [35.0,120.5],[36.0,120.5],[37.0,122.0],[37.5,122.5],[38.0,121.5],
    [38.5,121.5],[39.0,121.5],[39.5,122.5],[40.0,124.0],[40.5,122.5],
    [40.0,121.0],[39.5,121.5],[39.0,122.5],[39.5,123.0],[40.0,124.5],
    [40.5,125.0],[41.0,124.5],[40.5,122.5],[40.0,122.0],[40.5,121.0],
    [41.5,121.0],[42.0,121.5],[42.5,122.0],[43.0,122.5],[43.5,122.5],
    [44.0,122.5],[44.5,123.5],[44.0,124.5],[44.5,126.0],[45.0,132.0],
    [45.5,134.5],[46.0,136.5],[46.5,138.0],[47.0,138.0],[47.5,139.0],
    [48.0,139.0],[48.5,139.5],[49.0,140.0],[49.5,140.5],[50.0,140.5],
    [51.0,141.0],[52.0,141.0],[53.0,141.0],[54.0,141.5],[55.0,141.5],
    [56.0,143.0],[57.0,144.0],[58.0,143.0],[59.0,143.0],[60.0,143.0],
    [61.0,147.0],[62.0,148.0],[63.0,148.5],[64.0,150.0],[65.0,152.0],
    [66.0,154.0],[67.0,155.0],[68.0,156.0],[69.0,158.0],[70.0,158.0],
    [71.1,28.2],
  ],
  ...
  [
    ...
    [35.8,-5.4],[35.0,-4.0],[34.0,-2.0],[33.5,0.0],[33.0,2.0],
    [32.5,4.5],[32.0,6.5],[31.5,8.5],[31.0,10.0],[30.5,11.5],
    [30.0,12.5],[30.0,13.0],[30.5,14.0],[30.5,15.5],[30.0,16.0],
    [30.0,17.5],[30.0,19.0],[30.0,21.0],[30.0,23.0],[30.0,25.0],
    [30.0,27.0],[29.5,28.5],[30.5,30.0],[31.0,30.5],[31.5,32.0],
    [31.0,32.5],[30.5,32.5],[30.0,32.5],
    // 紅海沿岸〜アフリカの角
    [30.0,32.5],[29.5,33.0],[28.5,33.0],[27.5,33.5],[26.5,33.5],
    [25.5,33.5],[24.5,33.0],[23.5,32.5],[22.5,32.0],[22.0,37.0],
    [21.5,38.5],[20.5,39.5],[19.5,40.0],[18.5,40.5],[17.5,41.0],
    [16.5,41.5],[15.5,41.5],[14.5,42.5],[13.5,43.0],[12.5,43.5],
    [11.5,43.5],[11.0,45.0],[10.5,46.5],[10.0,47.5],[9.5,49.0],
    [9.0,50.5],[10.5,51.0],[11.5,51.0],[11.0,50.0],[11.5,49.0],
    [12.0,48.0],[12.5,46.5],[13.0,45.5],[13.5,44.5],[14.0,44.0],
    [14.5,43.0],[15.0,42.5],[15.5,41.5],[16.0,41.5],[16.5,41.0],
    [17.0,41.5],[17.5,41.0],[17.0,40.5],[16.5,40.5],[16.0,40.5],
    [15.5,40.0],[15.0,40.0],[15.0,41.5],[14.5,42.0],[14.0,43.0],
    [13.5,44.0],[13.0,45.5],[12.5,47.0],[12.0,49.0],[11.5,51.0],
    [11.5,52.0],[10.5,51.5],[10.0,51.5],[10.5,52.5],[11.5,51.5],
    [11.5,49.5],[11.0,47.5],[10.5,46.0],[11.0,45.0],[11.5,43.5],
    [11.5,42.0],[11.0,42.5],[10.5,42.5],[10.0,42.5],[9.5,41.5],
    // インド洋岸・タンザニア・モザンビーク
    [8.5,40.5],[7.5,41.5],[6.5,41.5],[5.5,41.5],[4.5,41.5],
    [3.5,41.5],[2.5,41.5],[1.5,41.5],[0.5,40.5],[-0.5,40.0],
    [-1.5,40.5],[-2.5,41.0],[-3.5,40.5],[-4.5,40.0],[-5.5,39.5],
    [-6.5,39.5],[-7.5,40.0],[-8.5,40.0],[-9.5,40.5],[-10.5,40.5],
    [-11.5,40.5],[-12.5,40.5],[-13.5,40.5],[-14.5,40.5],[-15.5,40.0],
    [-16.5,38.5],[-17.5,37.0],[-18.5,35.5],[-19.5,34.5],[-20.5,34.5],
    [-21.5,35.5],[-22.5,35.5],[-23.5,35.5],[-24.5,35.0],[-25.5,33.5],
    // 南アフリカ・喜望峰
    [-26.5,32.5],[-27.5,32.5],[-28.5,32.0],[-29.5,31.0],[-30.5,30.5],
    [-31.5,29.5],[-32.5,28.5],[-33.5,27.0],[-34.0,26.5],[-34.5,26.0],
    [-34.8,20.0],[-34.5,18.5],[-34.0,18.0],[-33.5,17.5],[-33.0,18.0],
    [-32.5,18.0],[-32.0,18.5],[-31.5,18.0],[-31.0,17.5],[-30.5,17.5],
    [-30.0,17.5],[-29.5,17.0],[-29.0,17.0],[-28.5,16.5],[-28.0,16.5],
    [-27.5,16.0],[-27.0,15.5],[-26.5,15.0],[-26.0,14.5],[-25.5,14.0],
    [-24.5,14.0],[-23.5,14.5],[-22.5,14.0],[-21.5,14.0],[-20.5,14.5],
    [-19.5,13.0],[-18.5,12.5],[-17.5,11.5],[-17.0,11.0],[-16.5,11.5],
    [-16.0,12.0],[-15.0,12.0],[-14.0,12.0],[-13.0,12.0],[-12.0,13.5],
    [-11.0,14.5],[-10.0,14.5],[-9.0,15.0],[-8.0,15.5],[-7.0,15.5],
    [-6.0,15.0],[-5.0,14.5],[-4.0,13.5],[-3.5,12.0],[-3.0,11.5],
    [-2.5,11.0],[-2.0,10.0],[-1.5,9.5],[-1.0,9.0],[-0.5,8.5],
    [0.5,8.5],[1.5,7.5],[2.0,6.5],[2.5,6.5],[3.5,6.5],[4.5,6.0],
    [5.0,5.5],[5.5,5.0],[6.0,5.0],[6.5,4.5],[7.0,4.5],[7.5,4.5],
    [8.0,4.5],[8.5,4.5],[9.0,4.0],[9.5,4.0],[10.0,3.5],
    // ギニア湾〜カメルーン
    [10.0,3.0],[9.5,3.5],[9.0,3.5],[8.5,4.0],[8.0,4.5],[7.5,5.0],
    [7.0,5.0],[6.5,5.0],[6.0,5.5],[5.5,5.5],[5.0,6.0],[4.5,6.0],
    [4.0,6.5],[3.5,7.0],[3.0,7.5],[2.5,7.5],[2.0,8.0],[1.5,8.5],
    [1.0,8.5],[0.5,8.0],[0.0,7.5],[-0.5,7.5],[-1.0,8.0],[-1.5,8.5],
    [-2.0,9.0],[-2.5,9.5],[-3.0,10.0],[-3.5,10.0],[-4.0,10.5],
    [-4.5,11.0],[-5.0,11.5],[-5.5,11.5],[-6.0,11.5],[-6.5,11.0],
    [-7.0,11.0],[-7.5,11.5],[-8.0,11.5],[-8.5,12.0],[-9.0,12.5],
    [-9.5,13.0],[-10.0,13.5],[-10.5,14.5],[-11.0,15.0],[-11.5,15.0],
    [-12.0,14.5],[-12.5,14.5],[-13.0,15.0],[-13.5,15.5],[-14.0,16.0],
    [-14.5,16.5],[-15.0,17.0],[-15.5,17.5],[-16.0,17.5],[-16.5,17.0],
    [-17.0,16.5],[-17.5,16.5],[-17.5,15.0],[-17.0,14.5],[-16.5,14.5],
    [-16.0,14.5],[-15.5,14.0],[-15.0,13.5],[-15.0,12.5],[-14.5,12.0],
    [-14.0,11.5],[-13.5,11.0],[-13.0,10.5],[-13.0,11.5],[-13.5,12.5],
    [-14.0,13.5],[-14.5,14.0],[-15.0,14.5],[-15.5,15.0],[-16.0,15.5],
    // セネガル〜モーリタニア
    [-16.5,16.0],[-17.0,16.5],[-17.5,17.0],[-18.0,17.5],[-18.5,18.0],
    [-19.0,18.5],[-20.0,19.0],[-21.0,19.5],[-22.0,20.0],[-23.0,20.5],
    [-24.0,21.5],[-24.5,22.5],[-24.5,23.5],[-23.5,24.0],[-22.5,24.5],
    [-21.5,25.0],[-20.5,25.5],[-20.0,26.0],[-19.5,26.5],[-19.0,27.0],
    [-18.0,27.5],[-17.0,28.0],[-15.0,28.5],[-13.5,29.5],[-12.5,29.5],
    [-12.0,29.5],[-11.5,29.5],[-11.0,29.5],[-10.5,29.5],[-10.0,29.5],
    [-9.0,28.5],[-8.0,28.0],[-7.0,28.0],[-6.0,28.5],[-5.0,29.0],
    [-4.0,29.5],[-3.0,30.0],[-2.0,30.5],[-1.0,30.5],[0.0,30.5],
    [1.0,31.0],[2.0,31.0],[3.0,30.5],[4.5,30.5],[6.0,31.0],
    [7.5,31.5],[9.0,31.5],[10.5,31.5],[12.0,32.5],[13.0,33.0],
    [14.0,33.0],[15.0,33.0],[16.0,33.0],[17.0,33.5],[18.0,34.0],
    [19.5,34.0],[21.0,33.5],[22.5,33.5],[24.0,33.5],[25.5,33.5],
    [27.0,33.5],[28.5,33.5],[30.0,32.5],[30.5,31.5],[31.5,31.5],
    [31.5,32.0],[31.0,32.5],[30.5,32.5],[30.0,32.5],[31.0,31.5],
    [31.5,30.5],[31.5,30.0],[32.0,29.5],[32.5,29.0],[33.0,28.5],
    [33.0,27.5],[32.5,27.0],[32.0,26.5],[32.5,25.0],[33.0,24.5],
    [33.0,23.0],[33.0,21.5],[33.0,20.0],[33.5,19.0],[34.0,18.5],
    [34.5,18.0],[35.5,16.5],[36.0,15.5],[36.5,14.5],[37.0,13.5],
    [37.5,12.5],[38.0,12.0],[38.0,11.5],[37.5,11.5],[37.0,11.5],
    [36.5,11.0],[36.0,10.5],[35.5,10.0],[35.0,9.0],[34.5,8.5],
    [34.0,8.0],[33.5,7.5],[33.0,7.0],[33.0,6.0],[33.0,5.0],
    [33.0,4.0],[33.0,3.0],[33.0,2.5],[33.5,1.5],[34.0,0.5],
    [34.5,-0.5],[35.0,-2.0],[35.5,-4.0],[35.8,-5.4],
  ],
  ...
  [
    // アラスカ北岸
    [71.5,-156],[70.8,-148],[70.0,-142],[69.2,-141],
    // アラスカ南岸・太平洋岸
    [60.0,-141],[59.5,-144],[59.0,-148],[58.5,-152],[58.0,-154],
    [57.5,-153],[57.0,-152],[56.5,-154],[56.0,-158],[55.5,-161],
    [55.0,-163],[54.5,-164],[54.0,-166],[55.0,-162],[56.0,-158],
    [57.0,-154],[58.0,-152],[59.0,-152],[60.0,-146],[61.0,-148],
    [61.5,-146],[62.0,-144],[62.5,-142],[63.0,-141],[63.5,-136],
    [64.0,-134],[64.5,-132],[65.0,-130],[64.5,-128],[63.0,-128],
    [62.0,-130],[60.5,-130],[59.0,-134],[57.5,-134],[56.0,-130],
    [54.5,-130],[53.0,-128],[52.0,-128],[51.5,-128],[50.5,-126],
    [49.5,-124],[49.0,-124],
    // カナダ〜アメリカ西岸
    [48.5,-124],[48.0,-124],[47.5,-124],[47.0,-124],[46.5,-124],
    [46.0,-124],[45.5,-124],[45.0,-124],[44.5,-124],[44.0,-124],
    [43.5,-124],[43.0,-124],[42.5,-124],[42.0,-124],[41.5,-124],
    [41.0,-124],[40.5,-124],[40.0,-124],[39.5,-124],[39.0,-124],
    [38.5,-123],[38.0,-123],[37.5,-122],[37.0,-122],[36.5,-122],
    [36.0,-121],[35.5,-121],[35.0,-121],[34.5,-120],[34.0,-119],
    [33.5,-118],[33.0,-117],[32.5,-117],[32.0,-117],
    // バハカリフォルニア〜メキシコ西岸
    [31.5,-115],[31.0,-114],[30.5,-114],[30.0,-114],[29.5,-114],
    [29.0,-114],[28.5,-114],[28.0,-114],[27.5,-113],[27.0,-112],
    [26.5,-111],[26.0,-110],[25.5,-110],[25.0,-110],[24.5,-110],
    [24.0,-110],[23.5,-109],[23.0,-107],[22.5,-106],[22.0,-106],
    [21.5,-105],[21.0,-105],[20.5,-104],[20.0,-104],[19.5,-104],
    [19.0,-104],[18.5,-103],[18.0,-102],[17.5,-101],[17.0,-100],
    [16.5,-99],[16.0,-98],[15.5,-97],[15.0,-96],[14.5,-92],
    [14.0,-90],[14.5,-89],[14.0,-88],
    // 中米・メキシコ湾岸
    [15.0,-86],[15.5,-84],[16.0,-86],[16.5,-88],[17.0,-89],
    [18.0,-88],[18.5,-88],[18.0,-92],[18.5,-94],[19.0,-96],
    [20.0,-97],[21.0,-97],[22.0,-98],[23.0,-98],[24.0,-98],
    [25.0,-97],[26.0,-97],[27.0,-97],[28.0,-97],[29.0,-95],
    [29.5,-94],[30.0,-94],[29.5,-90],[29.0,-89],[29.5,-88],
    [30.0,-88],[30.5,-88],[31.0,-88],[32.0,-88],[32.5,-86],
    [32.0,-84],[31.0,-84],[30.5,-82],[30.0,-81],
    // フロリダ半島
    [30.5,-82],[31.0,-82],[31.5,-80],[30.5,-80],[29.5,-81],
    [29.0,-80],[28.5,-80],[28.0,-80],[27.5,-80],[27.0,-80],
    [26.5,-80],[26.0,-80],[25.5,-80],[25.0,-80],[25.5,-81],
    [26.0,-82],[27.0,-83],[28.0,-83],[28.5,-84],[29.0,-84],
    [29.5,-83],[30.0,-83],[30.5,-84],[30.5,-86],[30.0,-88],
    [29.5,-90],[30.0,-90],[30.5,-90],[31.0,-90],[31.5,-90],
    [32.0,-90],[32.5,-90],[33.0,-88],[33.5,-88],[34.0,-88],
    [34.5,-87],[35.0,-85],[35.5,-82],[36.0,-80],[36.5,-76],
    [37.0,-76],[37.5,-75],[38.0,-75],[38.5,-74],[39.0,-74],
    [39.5,-74],[40.0,-74],[40.5,-74],[41.0,-72],[41.5,-70],
    [42.0,-70],[42.5,-70],[43.0,-70],[43.5,-70],[44.0,-68],
    [44.5,-68],[45.0,-67],[45.5,-66],[46.0,-66],
    // カナダ東岸
    [47.0,-53],[48.0,-53],[49.0,-54],[50.0,-56],[51.0,-56],
    [52.0,-56],[53.0,-57],[54.0,-58],[55.0,-60],[56.0,-62],
    [57.0,-62],[58.0,-64],[59.0,-64],[60.0,-64],[61.0,-65],
    [62.0,-66],[63.0,-64],[64.0,-66],[65.0,-62],[66.0,-60],
    [67.0,-64],[68.0,-66],[69.0,-66],[70.0,-68],[71.0,-70],
    [72.0,-74],[73.0,-80],[73.0,-90],[72.0,-92],[71.0,-90],
    [70.0,-86],[69.0,-84],[68.0,-84],[67.0,-82],[66.0,-82],
    [65.0,-82],[64.0,-82],[63.0,-80],[62.0,-80],[61.0,-80],
    [60.0,-78],[59.0,-78],[58.0,-76],[57.0,-76],[56.0,-76],
    [55.0,-74],[54.0,-74],[53.0,-72],[52.0,-72],[51.0,-68],
    [50.0,-66],[49.0,-66],[48.5,-64],[48.0,-66],[47.5,-68],
    [46.5,-70],[45.5,-72],[45.0,-74],[44.5,-76],[44.0,-78],
    [43.5,-80],[43.0,-82],[43.5,-84],[44.0,-84],[44.5,-82],
    [45.0,-80],[46.0,-84],[46.5,-86],[47.0,-88],[47.5,-90],
    [47.0,-92],[46.5,-92],[46.0,-90],[45.0,-88],[44.5,-88],
    [44.0,-88],[43.5,-87],[42.5,-88],[41.5,-88],[41.0,-86],
    [42.0,-86],[43.0,-86],[44.0,-86],[43.5,-84],[43.0,-82],
    [42.5,-80],[42.0,-80],[41.5,-82],[41.0,-83],[40.5,-82],
    [40.0,-80],[39.5,-80],[39.0,-77],[38.5,-75],[38.0,-76],
    [38.5,-77],[39.0,-76],[39.0,-74],[40.5,-74],[41.0,-72],
    [47.0,-60],[48.0,-60],[49.0,-62],[50.0,-64],[51.0,-56],
    [52.0,-56],[53.0,-56],[54.0,-58],[55.0,-60],[56.0,-62],
    [57.0,-62],[58.0,-64],[59.0,-64],[60.0,-64],[61.0,-66],
    [62.0,-66],[63.0,-64],[64.0,-66],[65.0,-64],[66.0,-62],
    [67.0,-60],[68.0,-58],[69.0,-56],[70.0,-56],[71.0,-56],
    [72.0,-58],[73.0,-62],[74.0,-66],[75.0,-70],[76.0,-74],
    [77.0,-78],[78.0,-82],[79.0,-86],[80.0,-90],[81.0,-88],
    [82.0,-82],[83.0,-74],[84.0,-68],[83.0,-60],[82.0,-56],
    [81.0,-50],[80.0,-46],[79.0,-44],[78.0,-42],[77.0,-46],
    [76.0,-50],[75.0,-56],[74.0,-62],[73.0,-66],[72.0,-70],
    [71.5,-156],
  ],
  ...
  // ══════════════════════════════════════════════════════
  [
    [12.5,-72.0],[11.5,-70.0],[10.5,-63.0],[9.5,-62.0],[8.5,-62.0],
    [7.5,-60.0],[6.5,-61.0],[5.5,-57.0],[4.5,-52.0],[3.5,-51.0],
    [2.5,-50.0],[1.5,-50.0],[0.5,-50.0],[-0.5,-50.0],[-1.5,-48.0],
    [-2.5,-44.0],[-3.5,-37.0],[-4.5,-37.0],[-5.5,-35.5],[-6.5,-35.0],
    [-7.5,-35.0],[-8.5,-35.0],[-9.5,-37.0],[-10.5,-37.5],[-11.5,-38.0],
    [-12.5,-38.0],[-13.5,-39.0],[-14.5,-39.0],[-15.5,-39.0],[-16.5,-39.0],
    [-17.5,-39.0],[-18.5,-39.5],[-19.5,-40.0],[-20.5,-40.5],[-21.5,-41.0],
    [-22.5,-43.0],[-23.0,-44.0],[-23.5,-45.5],[-24.5,-47.5],[-25.5,-48.5],
    [-26.5,-48.5],[-27.5,-48.5],[-28.5,-49.5],[-29.5,-50.0],[-30.0,-51.0],
    [-30.5,-52.0],[-31.5,-52.0],[-32.5,-53.0],[-33.5,-54.0],[-34.5,-56.5],
    [-35.5,-57.5],[-36.5,-57.5],[-37.5,-58.5],[-38.5,-61.0],[-39.5,-62.0],
    [-40.5,-63.0],[-41.5,-64.0],[-42.5,-65.0],[-43.5,-66.0],[-44.5,-66.5],
    [-45.5,-67.0],[-46.5,-67.5],[-47.5,-67.5],[-48.5,-67.5],[-49.5,-68.0],
    [-50.5,-69.0],[-51.5,-69.5],[-52.5,-70.0],[-53.5,-70.5],[-54.0,-68.0],
    [-53.0,-68.0],[-52.0,-68.0],[-51.0,-68.0],[-50.0,-67.0],[-49.0,-67.5],
    [-48.0,-67.5],[-47.0,-68.0],[-46.0,-68.0],[-45.0,-67.5],[-44.0,-67.5],
    [-43.0,-67.5],[-42.0,-67.5],[-41.0,-67.5],[-40.0,-67.5],[-39.0,-66.0],
    [-38.0,-64.0],[-37.0,-62.5],[-36.0,-60.0],[-35.0,-58.0],[-34.0,-58.0],
    [-33.0,-56.0],[-32.0,-54.0],[-31.0,-52.0],[-30.0,-52.0],[-29.0,-50.0],
    [-28.0,-49.5],[-27.0,-50.0],[-26.0,-48.0],[-25.0,-48.0],[-24.0,-46.0],
    [-23.0,-44.0],[-22.0,-43.0],[-21.0,-41.0],[-20.0,-40.5],[-19.0,-40.0],
    [-18.0,-39.0],[-17.0,-39.0],[-16.0,-39.0],[-15.0,-38.5],[-14.0,-38.5],
    [-13.0,-38.5],[-12.0,-38.5],[-11.0,-38.0],[-10.0,-37.5],[-9.0,-37.0],
    [-8.0,-37.0],[-7.0,-37.0],[-6.0,-37.0],[-5.0,-38.0],[-4.0,-38.5],
    [-3.0,-42.5],[-2.0,-45.0],[-1.0,-47.0],[0.0,-48.0],[1.0,-50.0],
    [2.0,-50.0],[3.0,-52.0],[4.0,-52.0],[5.0,-56.0],[6.0,-58.0],
    [7.0,-60.0],[8.0,-62.0],[9.0,-62.0],[10.0,-62.0],[11.0,-66.0],
    [12.5,-72.0],
  ],
  ...
  // ══════════════════════════════════════════════════════
  [
    [-13.5,136.5],[-13.0,136.0],[-13.0,130.0],[-13.5,128.0],
    [-14.0,127.0],[-15.0,125.5],[-16.0,124.0],[-17.0,122.5],
    [-18.5,122.0],[-20.0,119.5],[-21.5,115.5],[-22.5,114.0],
    [-24.0,113.5],[-25.5,113.5],[-27.0,113.5],[-28.5,114.5],
    [-29.5,115.0],[-31.0,115.5],[-32.0,115.5],[-32.5,116.0],
    [-33.0,116.5],[-33.5,116.0],[-33.5,118.0],[-33.0,120.0],
    [-33.5,121.0],[-32.5,124.0],[-32.5,128.0],[-31.5,128.0],
    [-31.5,131.5],[-32.0,133.5],[-32.5,134.0],[-32.0,136.5],
    [-33.0,136.5],[-33.5,138.5],[-35.5,138.0],[-36.0,139.0],
    [-37.0,140.0],[-38.0,140.0],[-38.5,141.5],[-38.0,143.0],
    [-37.5,144.5],[-38.5,146.0],[-37.5,147.5],[-36.5,149.5],
    [-35.5,150.0],[-34.0,151.5],[-33.0,152.0],[-32.0,152.5],
    [-30.5,153.0],[-29.0,153.5],[-28.0,153.5],[-26.5,153.0],
    [-25.0,153.0],[-23.5,152.5],[-22.5,150.5],[-21.0,149.5],
    [-19.5,148.5],[-18.5,147.0],[-17.5,146.0],[-16.5,146.0],
    [-15.5,145.5],[-15.0,144.5],[-14.5,145.0],[-14.0,144.0],
    [-14.0,142.5],[-14.0,141.5],[-14.5,141.0],[-14.0,140.0],
    [-13.5,136.5],
  ],
  ...
  // ══════════════════════════════════════════════════════
  [
    [83.6,-30.0],[82.5,-22.0],[81.5,-18.0],[80.5,-18.0],[79.5,-20.0],
    [78.5,-19.0],[77.5,-17.0],[76.5,-19.0],[75.5,-19.0],[74.5,-21.0],
    [73.5,-22.0],[73.0,-24.0],[72.5,-26.0],[71.5,-26.0],[70.5,-27.5],
    [69.5,-26.0],[68.5,-25.0],[68.0,-24.0],[67.5,-20.0],[68.0,-18.0],
    [68.5,-17.0],[69.0,-14.0],[70.0,-14.0],[70.5,-16.0],[71.0,-14.0],
    [71.5,-14.0],[72.0,-18.0],[73.0,-20.0],[73.5,-22.0],[74.0,-22.0],
    [74.5,-20.0],[75.0,-20.0],[75.5,-22.0],[75.0,-24.0],[74.5,-26.0],
    [75.0,-28.0],[75.5,-30.0],[76.0,-30.0],[77.0,-26.0],[78.0,-24.0],
    [79.0,-22.0],[80.0,-22.0],[80.5,-24.0],[81.0,-28.0],[81.5,-32.0],
    [82.0,-36.0],[82.5,-38.0],[83.0,-38.0],[83.5,-34.0],[83.6,-30.0],
  ],
  ...
  // ══════════════════════════════════════════════════════
  [
    [34.0,131.0],[34.5,132.5],[35.0,133.5],[35.5,135.0],[35.5,136.5],
    [35.5,138.0],[35.0,139.0],[35.5,139.5],[36.0,140.5],[36.5,140.5],
    [37.0,140.5],[37.5,141.0],[38.0,141.5],[38.5,141.5],[39.0,142.0],
    [39.5,142.0],[40.0,141.5],[40.5,141.5],[41.0,141.5],[41.5,140.5],
    [42.0,140.0],[42.5,140.5],[43.0,141.0],[43.5,141.5],[44.0,144.5],
    [44.5,143.5],[44.0,142.5],[43.5,141.0],[43.0,141.5],[42.5,142.5],
    [42.0,141.5],[41.5,141.0],[41.0,141.5],[40.5,141.5],[40.0,141.5],
    [39.5,142.0],[39.0,141.5],[38.5,141.0],[38.0,141.0],[37.5,140.5],
    [37.0,140.5],[36.5,136.5],[36.0,136.5],[35.5,136.5],[35.0,137.0],
    [34.5,137.0],[34.0,136.5],[33.5,135.5],[33.0,131.5],[33.5,131.0],
    [34.0,131.0],
  ],
  // 北海道
  [
    [44.0,141.0],[43.5,141.5],[42.5,142.0],[43.0,143.0],[43.5,144.0],
    [44.0,145.0],[44.5,144.0],[45.0,143.0],[45.5,142.0],[45.0,141.5],
    [44.5,141.5],[44.0,141.0],
  ],
  // 九州
  [[34.0,131.0],[32.5,130.5],[32.0,130.5],[31.5,130.5],[32.0,131.5],[33.0,131.5],[34.0,131.0]],
  // 四国
  [[34.0,134.0],[33.5,133.5],[33.0,132.5],[33.5,134.0],[34.0,135.0],[34.0,134.0]],
  // 朝鮮半島
  [[38.5,124.5],[34.0,126.5],[34.5,129.5],[35.5,129.5],[37.0,129.0],[38.5,128.5],[38.5,124.5]],
  // 台湾
  [[25.5,122.0],[22.0,120.5],[22.0,121.0],[23.5,121.5],[25.0,121.5],[25.5,122.0]],
  // グレートブリテン
  [
    [58.5,-3.0],[57.5,-6.0],[55.5,-6.0],[53.5,-5.0],[51.5,-5.0],
    [50.0,-4.0],[50.0,-0.5],[51.0,1.5],[52.5,1.5],[54.0,0.5],
    [55.5,0.0],[57.5,-2.0],[58.5,-3.0],
  ],
  // アイスランド
  [[66.5,-24.0],[63.5,-24.0],[63.5,-14.0],[66.0,-13.0],[66.5,-24.0]],
  // スマトラ
  [[5.5,95.5],[5.0,97.0],[4.0,98.5],[3.0,100.0],[2.0,101.0],[1.0,102.0],
   [0.0,103.0],[-1.0,102.5],[-2.0,101.0],[-2.5,101.5],[-3.5,103.5],
   [-4.0,104.5],[-5.5,105.5],[-5.0,105.0],[-4.0,102.0],[-2.5,100.5],
   [-1.5,100.0],[0.0,100.0],[1.5,99.5],[3.0,98.5],[4.5,96.5],[5.5,95.5]],
  // ボルネオ
  [[7.5,117.5],[6.0,116.0],[4.5,118.5],[3.0,117.5],[1.5,110.5],
   [0.5,109.5],[1.0,109.0],[2.5,111.0],[4.0,117.5],[5.5,118.0],
   [7.5,117.5]],
  // スリランカ
  [[9.8,80.5],[8.0,79.8],[6.5,81.0],[7.0,82.5],[8.5,81.5],[9.8,80.5]],
  // マダガスカル
  [[-12.5,49.5],[-14.0,47.5],[-17.0,44.5],[-20.0,44.0],[-22.0,43.5],
   [-24.5,44.0],[-25.5,44.5],[-25.5,47.5],[-23.5,48.0],[-20.0,48.5],
   [-17.0,50.0],[-14.0,50.5],[-12.5,49.5]],
  // フィリピン（ルソン）
  [[18.5,122.0],[17.5,120.5],[16.5,120.5],[15.5,121.0],[14.5,121.5],
   [13.5,123.0],[14.0,124.0],[15.0,123.5],[16.0,122.5],[17.5,122.0],[18.5,122.0]],
  // キューバ
  [[23.0,-84.5],[22.5,-84.0],[22.0,-80.5],[22.5,-80.0],[23.0,-83.0],[23.0,-84.5]],
  // ニュージーランド（南島）
  [[-40.5,172.5],[-43.5,171.0],[-46.5,168.5],[-46.0,169.5],[-43.0,172.0],[-40.5,172.5]],
  // ニュージーランド（北島）
  [[-34.5,173.0],[-37.5,178.5],[-39.0,177.0],[-38.5,175.0],[-37.0,174.5],[-34.5,173.0]],
...
function drawContinent(pts,W,H,fill,stroke,lw){
  ...
  for(const[la,lo]of pts){
    ...
    if(x<-20||x>W+20||y<-20||y>H+20){ first=true; continue; } // 画面外スキップ
...
function drawContinents(W,H){
  // 島・半島は塗りを薄く・線を細く
  const islandFill   = 'rgba(170,160,225,.22)';
  const islandStroke = 'rgba(110,90,200,.38)';
  // メイン大陸: インデックス0-5
  CONTINENTS.slice(0,6).forEach(pts => drawContinent(pts,W,H));
  // 小地物（島・半島）: インデックス6以降
  CONTINENTS.slice(6).forEach(pts => drawContinent(pts,W,H,islandFill,islandStroke,0.5));
}
...
function initCompass(){
  try {
    ...
    if(geoGranted&&userLat){
      ...
      const lbl=getEl('compassFromLabel');
      if(lbl){
        lbl.innerHTML=`<span class="txt-jp">${TOUR[0].city} → ${TOUR[1].city} (📍タップで現在地から)</span><span class="txt-en" style="display:${lang==='en'?'':'none'}">${TOUR[0].city} → ${TOUR[1].city} (tap 📍 for your location)</span>`;
      }
    }
