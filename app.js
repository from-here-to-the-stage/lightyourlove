...
const CONTINENTS=[
  ...
  // ── アジア（シベリア〜東南アジア〜アラビア半島）──────────────────
  [
    [77,103],[75,88],[73,70],[72,55],[71,42],[70,30],[70,20],[68,32],
    [66,28],[64,22],[62,16],[60,14],[58,12],[56,10],[54,10],[52,8],
    [50,4],[48,2],[46,0],[44,2],[42,4],[40,12],[38,22],[36,28],
    [34,32],[32,34],[30,36],[28,34],[26,36],[24,38],[22,40],[20,40],
    [18,42],[16,44],[14,44],[18,74],[16,74],[14,76],[12,78],[10,80],
    [8,78],[10,80],[12,80],[14,78],[16,76],[18,74],[20,72],[22,70],
    [24,68],[26,66],[28,64],[24,72],[22,74],[20,74],[18,74],[20,76],
    [22,78],[24,82],[26,86],[28,90],[24,92],[22,94],[20,94],[18,96],
    [16,98],[14,100],[12,100],[10,100],[8,98],[6,100],[4,102],[2,102],
    [0,104],[2,104],[4,104],[6,102],[8,100],[10,100],[12,100],[14,100],
    [16,98],[18,96],[20,94],[22,96],[24,98],[22,100],[20,100],[18,100],
    [16,106],[14,108],[12,108],[10,108],[12,110],[14,110],[16,108],
    [18,106],[20,108],[22,114],[24,118],[26,120],[28,122],[30,122],
    [32,122],[34,120],[36,120],[38,118],[40,122],[42,122],[44,132],
    [46,138],[44,144],[42,142],[40,142],[38,142],[36,136],[34,132],
    [32,130],[30,122],[28,122],[30,124],[32,122],[30,120],[28,120],
    [26,120],[28,118],[30,114],[32,112],[34,108],[36,104],[38,100],
    [40,96],[42,90],[44,86],[46,82],[48,78],[50,72],[52,68],[54,64],
    [56,60],[58,56],[60,52],[62,48],[64,44],[66,40],[68,38],[70,36],
    [72,40],[74,50],[76,62],[77,80],[77,103]
  ],

  // ── ヨーロッパ（スカンジナビア〜イベリア）──────────────────────
  [
    [71,26],[70,22],[68,18],[66,16],[64,12],[62,6],[60,5],[58,8],
    [56,10],[54,8],[52,4],[51,2],[50,0],[48,-2],[46,0],[44,2],
    [42,4],[40,0],[38,-4],[36,-6],[36,-8],[38,-8],[38,-6],[36,-4],
    [36,0],[38,2],[40,2],[40,4],[42,4],[42,8],[44,8],[44,12],
    [46,14],[48,14],[50,16],[52,14],[54,12],[56,10],[58,12],
    [60,12],[62,14],[64,18],[66,18],[68,20],[70,22],[70,26],
    [68,26],[66,24],[68,26],[70,28],[71,26]
  ],

  // ── アフリカ（詳細海岸線）────────────────────────────────────
  [
    [37,12],[36,10],[34,8],[32,4],[30,2],[28,-2],[26,-8],[24,-14],
    [22,-16],[20,-16],[18,-16],[16,-16],[14,-16],[12,-16],[10,-14],
    [8,-14],[6,-12],[4,-8],[2,-6],[0,-2],[2,2],[4,4],[6,4],[8,2],
    [6,0],[4,2],[2,6],[0,10],[2,14],[4,14],[6,12],[8,14],[10,14],
    [12,14],[14,14],[12,14],[10,16],[12,18],[14,18],[16,18],[18,20],
    [20,20],[22,20],[20,22],[18,24],[16,24],[14,24],[12,22],[10,20],
    [8,20],[6,22],[4,28],[2,30],[0,32],[2,34],[4,36],[6,38],[8,40],
    [10,42],[12,44],[14,42],[16,40],[18,38],[20,38],[22,38],[24,36],
    [26,34],[28,34],[30,32],[30,28],[28,26],[26,26],[24,28],[22,26],
    [20,24],[18,22],[16,20],[14,18],[16,18],[18,20],[20,22],[22,24],
    [24,26],[26,28],[28,30],[30,32],[32,30],[34,28],[36,24],[38,20],
    [38,14],[37,12]
  ],

  // ── 北アメリカ（アラスカ〜メキシコ詳細）────────────────────────
  [
    [71,-162],[69,-148],[67,-136],[65,-128],[63,-126],[61,-124],
    [59,-126],[57,-128],[55,-130],[53,-128],[51,-124],[49,-124],
    [47,-124],[45,-124],[43,-124],[41,-124],[39,-122],[37,-122],
    [35,-120],[33,-118],[31,-116],[29,-114],[27,-112],[25,-110],
    [23,-108],[21,-106],[19,-102],[17,-96],[15,-92],[13,-88],
    [15,-88],[17,-90],[19,-90],[21,-90],[23,-90],[25,-88],[23,-88],
    [21,-88],[19,-88],[17,-88],[15,-90],[17,-92],[19,-94],[21,-96],
    [21,-98],[19,-100],[17,-100],[17,-96],[19,-92],[21,-90],[23,-88],
    [25,-86],[27,-82],[29,-82],[31,-82],[31,-84],[29,-84],[29,-82],
    [31,-80],[33,-80],[35,-76],[37,-76],[39,-74],[41,-72],[43,-70],
    [43,-68],[45,-66],[45,-64],[43,-66],[41,-70],[39,-74],[37,-76],
    [35,-78],[33,-80],[35,-82],[37,-84],[39,-82],[41,-80],[43,-78],
    [45,-76],[47,-72],[49,-68],[51,-64],[53,-58],[55,-60],[57,-62],
    [59,-64],[61,-64],[63,-66],[65,-62],[67,-62],[69,-62],[71,-58],
    [71,-52],[69,-54],[67,-58],[69,-62],[71,-64],[73,-72],[73,-80],
    [71,-82],[69,-84],[67,-82],[65,-82],[63,-80],[61,-80],[59,-78],
    [57,-76],[55,-76],[53,-74],[51,-72],[49,-70],[47,-70],[45,-68],
    [43,-70],[41,-72],[39,-74],[37,-76],[35,-78],[33,-80],[31,-82],
    [29,-82],[27,-80],[25,-78],[23,-80],[21,-86],[19,-90],[17,-92],
    [15,-90],[17,-86],[19,-82],[21,-80],[23,-76],[25,-76],[25,-72],
    [23,-70],[21,-68],[19,-64],[17,-60],[15,-60],[17,-58],[19,-56],
    [21,-54],[19,-52],[15,-48],[17,-44],[19,-42],[21,-42],[23,-44],
    [25,-46],[27,-48],[29,-50],[31,-50],[33,-52],[35,-56],[37,-60],
    [39,-64],[41,-66],[43,-68],[45,-72],[47,-72],[49,-70],[51,-66],
    [53,-60],[55,-56],[57,-52],[59,-48],[61,-44],[63,-44],[65,-48],
    [67,-50],[69,-48],[71,-46],[73,-46],[75,-50],[77,-56],[77,-62],
    [75,-64],[73,-66],[71,-68],[73,-78],[73,-84],[71,-88],[71,-96],
    [71,-108],[71,-120],[71,-130],[71,-142],[71,-152],[71,-162]
  ],

  // ── 南アメリカ（コロンビア〜パタゴニア）─────────────────────────
  [
    [12,-74],[10,-62],[8,-62],[6,-62],[4,-60],[2,-58],[0,-50],
    [-2,-46],[-4,-40],[-6,-38],[-8,-36],[-10,-38],[-12,-40],
    [-14,-40],[-16,-40],[-18,-40],[-20,-42],[-22,-44],[-24,-46],
    [-26,-48],[-28,-50],[-30,-52],[-32,-54],[-34,-56],[-36,-58],
    [-38,-62],[-40,-64],[-42,-64],[-44,-66],[-46,-68],[-48,-68],
    [-50,-70],[-52,-72],[-54,-70],[-52,-68],[-50,-66],[-48,-68],
    [-46,-70],[-44,-70],[-42,-70],[-40,-68],[-38,-66],[-36,-60],
    [-34,-58],[-32,-54],[-30,-52],[-28,-50],[-26,-48],[-24,-44],
    [-22,-44],[-20,-42],[-18,-40],[-16,-38],[-14,-38],[-12,-38],
    [-10,-38],[-8,-36],[-6,-36],[-4,-38],[-2,-42],[0,-48],
    [2,-50],[4,-52],[6,-56],[8,-60],[10,-62],[12,-68],[12,-74]
  ],

  // ── オーストラリア（Great Barrier Reef側含む詳細）──────────────
  [
    [-14,136],[-12,136],[-12,130],[-13,128],[-15,126],[-17,122],
    [-20,118],[-22,114],[-25,114],[-28,114],[-30,114],[-31,116],
    [-32,116],[-32,118],[-30,118],[-28,116],[-30,120],[-32,124],
    [-32,128],[-30,128],[-30,132],[-32,134],[-32,136],[-32,138],
    [-34,140],[-36,140],[-38,140],[-36,142],[-34,144],[-32,146],
    [-30,148],[-28,150],[-26,152],[-24,152],[-22,150],[-20,148],
    [-18,148],[-18,146],[-20,144],[-22,142],[-22,140],[-20,138],
    [-18,136],[-16,136],[-14,136]
  ],

  // ── 日本（本州）────────────────────────────────────────────────
  [
    [34,131],[35,133],[35,135],[36,136],[37,136],[37,138],[38,140],
    [39,141],[40,141],[41,140],[42,140],[43,141],[44,144],[44,143],
    [42,140],[40,140],[38,140],[36,138],[34,136],[34,134],[34,132],
    [34,131]
  ],
  // 北海道
  [[44,141],[43,141],[42,140],[43,140],[44,143],[45,142],[44,141]],
  // 九州
  [[34,131],[32,130],[32,132],[33,132],[34,131]],
  // 四国
  [[34,134],[33,133],[33,134],[34,135],[34,134]],

  // ── 朝鮮半島 ──────────────────────────────────────────────────
  [[38,126],[34,126],[34,128],[35,130],[37,130],[38,128],[38,126]],

  // ── 台湾 ─────────────────────────────────────────────────────
  [[25,122],[22,120],[22,122],[23,122],[25,122]],

  // ── グレートブリテン島 ────────────────────────────────────────
  [
    [58,-4],[56,-6],[54,-6],[52,-4],[50,-4],[50,0],[52,2],
    [54,2],[56,0],[58,-2],[60,-2],[58,-4]
  ],
  // アイルランド
  [[54,-10],[52,-10],[52,-8],[54,-8],[54,-10]],

  // ── スカンジナビア半島 ────────────────────────────────────────
  [
    [70,28],[68,18],[66,14],[64,14],[62,6],[60,5],[58,6],
    [58,10],[60,12],[62,14],[64,14],[66,16],[68,18],[70,24],[70,28]
  ],

  // ── グリーンランド ────────────────────────────────────────────
  [
    [83,-30],[80,-20],[78,-20],[76,-24],[74,-26],[72,-26],[70,-28],
    [68,-26],[66,-20],[68,-14],[70,-14],[72,-18],[74,-20],[76,-18],
    [78,-16],[80,-16],[82,-18],[84,-22],[84,-30],[83,-30]
  ],

  // ── カムチャッカ半島 ──────────────────────────────────────────
  [[56,162],[54,160],[52,158],[54,158],[56,160],[58,162],[56,162]],

  // ── スマトラ ─────────────────────────────────────────────────
  [[6,106],[4,106],[2,104],[0,104],[0,100],[2,100],[4,98],[6,100],[6,106]],

  // ── ジャワ ───────────────────────────────────────────────────
  [[-6,106],[-8,112],[-8,114],[-8,112],[-6,108],[-6,106]],

  // ── ボルネオ ─────────────────────────────────────────────────
  [[8,116],[4,116],[0,110],[2,110],[4,114],[6,116],[8,116]],

  // ── フィリピン（ルソン島）────────────────────────────────────
  [[18,122],[16,120],[14,120],[14,122],[16,124],[18,122]],

  // ── スリランカ ────────────────────────────────────────────────
  [[10,80],[8,80],[8,82],[10,82],[10,80]],

  // ── マダガスカル ─────────────────────────────────────────────
  [[-12,50],[-18,44],[-26,44],[-26,48],[-18,48],[-12,50]],

  // ── ニュージーランド（南島）──────────────────────────────────
  [[-44,172],[-46,170],[-46,168],[-44,168],[-44,172]],
  // 北島
  [[-36,176],[-38,176],[-40,176],[-38,178],[-36,176]],

  // ── バフィン島（カナダ北部）──────────────────────────────────
  [[72,-66],[70,-68],[68,-70],[70,-72],[72,-70],[74,-66],[72,-66]],

  // ── キューバ ─────────────────────────────────────────────────
  [[22,-74],[22,-78],[22,-82],[22,-84],[22,-82],[22,-78],[22,-74]],
